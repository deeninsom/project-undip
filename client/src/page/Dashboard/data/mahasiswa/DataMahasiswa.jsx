...
import AddMahasiswa from "../../../../component/CRUD/Mahasiswa/AddMahasiswa";
import UpdateMahasiswa from "../../../../component/CRUD/Mahasiswa/UpdateMahasiswa";
import DelMahasiswa from "../../../../component/CRUD/Mahasiswa/DelMahasiswa";
import ('../../../../App.css')
const DataMahasiswa = () => {
    ...
    const getDataMahasiswa = async () => {
        try {
          const respon = await axios.get(
            ` http://localhost:5000/api/v1/mahasiswa?search=${keyword}&page=${page}&limit=${limit}`
          );
          // console.log(respon)
            ...
            <div className="col-lg-12 grid-margin stretch-card">
              <div className="card">
                <div className="card-body">
                  <h4 className="card-title">Table Mahasiswa</h4>
                  <nav className="navbar navbar-expand-lg navbar-light bg-transparent">
                    <div className="container-fluid">
                      ...
                      <AddMahasiswa isLoad={getDataMahasiswa} />
                    </div>
                  </nav>
